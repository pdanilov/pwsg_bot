...
confirm_button = types.InlineKeyboardButton(
    'Подтвердить',
    callback_data=ConfirmCB.new(answer='yes'),
)
cancel_button = types.InlineKeyboardButton(
    'Отмена',
    callback_data=ConfirmCB.new(answer='no'),
)
...
list_button = types.InlineKeyboardButton(
    ...
    callback_data=MenuCB.new(action='list'),
)
reset_button = types.InlineKeyboardButton(
    'Удалить все сохраненные места',
    callback_data=MenuCB.new(action='reset'),
)
